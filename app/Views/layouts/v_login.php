                ...
                <div class="card my-5 shadow-sm">
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-end mb-4">
                            ...
                            <a href="<?= site_url('/register') ?>" class="link-primary">Belum punya akun?</a>
                        </div>
                        <div class="form-group mb-3">
                            <label class="form-label">Alamat Email atau Username</label>
                            <input type="email" class="form-control" placeholder="Masukkan alamat email atau username...">
                        </div>
                        <div class="form-group mb-3">
