<div class="col-sm-12">
    <div class="card">
        ...
        <div class="card-body">
            <?= form_open('/admin/games/save', ['method' => 'POST', 'enctype' => 'multipart/form-data']) ?>
            <?= csrf_field() ?>
            <?php if (isset($game)) : ?>
                                ...
                                <div class="d-flex flex-column">
                                    <div class="image-preview mb-3 text-center" style="min-height: 200px; display: flex; align-items: center; justify-content: center; background-color: #f8f9fa;">
                                        <?php if (isset($game) && !empty($game['path_foto'])) : ?>
                                            <img src="<?= base_url('/assets/images/games/' . $game['path_foto']) ?>" alt="Preview" id="imagePreview" class="img-fluid" style="max-height: 200px;">
                                        <?php else : ?>
                                                ...
                                                <div class="card border">
                                                    <div class="card-body text-center p-3">
                                                        <?php if (!empty($option['path_foto'])) : ?>
                                                            <img src="<?= base_url('/assets/images/topup/' . $option['path_foto']) ?>" alt="Diamond" class="img-fluid mb-2" style="max-height: 80px;">
                                                        <?php else : ?>
    ...
    <div class="modal fade" id="addTopUpModal" tabindex="-1" aria-labelledby="addTopUpModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <?= form_open('', ['method' => 'POST', 'enctype' => 'multipart/form-data', 'id' => 'topUpForm']) ?>
